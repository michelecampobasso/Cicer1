<template>
  <div id="selectpois" role="main">
    <div class="pois-container">
      ...
      <div v-for="poi in pois" v-bind:class="[poi.is_selected ? 'selected' : '', 'poi']" @click="clickOnPoi(poi.id_cicer1)" @keyup.enter="clickOnPoi(poi.id_cicer1)" tabindex="1">
          <div class="left">
            <div class="name">
              {{poi.properties.nome}}
            </div>
      ...
      <div class="cta-buttons-container">
        <div @click="goToMap()" @keyup.enter="goToMap()" class="cta-button" tabindex="2" role="navigation">
